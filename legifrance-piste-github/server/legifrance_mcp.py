...
# ///
"""
Serveur MCP Légifrance — connecté à PISTE (piste.gouv.fr)
Les dépendances sont gérées automatiquement par uv.

Configuration requise (dans claude_desktop_config.json) :
  PISTE_CLIENT_ID      → votre client_id PISTE
  PISTE_CLIENT_SECRET  → votre client_secret PISTE
"""
...
def get_token() -> str:
    ...
    if not CLIENT_ID or not CLIENT_SECRET:
        raise EnvironmentError(
            "Clés PISTE manquantes. Lancez la commande /setup-piste dans Claude pour les configurer."
        )
